...
DOCUMENT_CONFIGS: dict[str, DocumentConfig] = {
    "cloud-service-agreement": DocumentConfig(
        ...
        fields=[
            FieldDef("customerName", "Full legal name of the customer"),
            FieldDef("providerName", "Full legal name of the cloud service provider"),
    ...
    "design-partner-agreement": DocumentConfig(
        ...
        fields=[
            FieldDef("providerName", "Full legal name of the provider"),
            FieldDef("partnerName", "Full legal name of the design partner"),
            FieldDef("effectiveDate", "Agreement effective date (YYYY-MM-DD)"),
    ...
    "service-level-agreement": DocumentConfig(
        ...
        fields=[
            FieldDef("providerName", "Full legal name of the service provider"),
            FieldDef("customerName", "Full legal name of the customer"),
    ...
    "professional-services-agreement": DocumentConfig(
        ...
        fields=[
            FieldDef("customerName", "Full legal name of the customer"),
            FieldDef("providerName", "Full legal name of the services provider"),
            FieldDef("effectiveDate", "Agreement effective date (YYYY-MM-DD)"),
            FieldDef("governingLaw", "Governing US state law"),
            FieldDef("chosenCourts", "Courts for dispute resolution"),
    ...
    "data-processing-agreement": DocumentConfig(
        ...
        fields=[
            FieldDef("customerName", "Full legal name of the data controller (customer)"),
            FieldDef("providerName", "Full legal name of the data processor (provider)"),
    ...
    "software-license-agreement": DocumentConfig(
        ...
        fields=[
            FieldDef("customerName", "Full legal name of the customer/licensee"),
            FieldDef("providerName", "Full legal name of the provider/licensor"),
            FieldDef("effectiveDate", "Agreement effective date (YYYY-MM-DD)"),
            FieldDef("governingLaw", "Governing US state law"),
            FieldDef("generalCapAmount", "General liability cap"),
    ...
    "partnership-agreement": DocumentConfig(
        ...
        fields=[
            FieldDef("companyName", "Full legal name of the company"),
            FieldDef("partnerName", "Full legal name of the partner"),
            FieldDef("effectiveDate", "Agreement effective date (YYYY-MM-DD)"),
    ...
    "business-associate-agreement": DocumentConfig(
        ...
        fields=[
            FieldDef("providerName", "Full legal name of the business associate (provider)"),
            FieldDef("companyName", "Full legal name of the covered entity (company)"),
    ...
    "ai-addendum": DocumentConfig(
        ...
        fields=[
            FieldDef("customerName", "Full legal name of the customer"),
            FieldDef("providerName", "Full legal name of the AI service provider"),
